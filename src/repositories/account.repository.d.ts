...
export declare class AccountRepository extends Repository {
    ...
    currentUser(): Promise<import("instagram-private-api/src/responses").AccountRepositoryCurrentUserResponseUser>;
    setBiography(text: string): Promise<import("instagram-private-api/src/responses").AccountRepositoryCurrentUserResponseUser>;
    changeProfilePicture(picture: Buffer): Promise<AccountRepositoryCurrentUserResponseRootObject>;
    editProfile(options: AccountEditProfileOptions): Promise<import("instagram-private-api/src/responses").AccountRepositoryCurrentUserResponseUser>;
