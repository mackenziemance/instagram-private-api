...
export declare class PublishService extends Repository {
    ...
    photo(options: PostingPhotoOptions): Promise<import("instagram-private-api/src/responses").MediaRepositoryConfigureResponseRootObject>;
    video(options: PostingVideoOptions): Promise<import("instagram-private-api/src/responses").MediaRepositoryConfigureResponseRootObject>;
